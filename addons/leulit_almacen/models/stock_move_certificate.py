...
class StockMoveCertificate(models.TransientModel):
    _name = 'stock.move_certificate'
    _inherit = ['mail.thread']
    _order = 'id desc'
    _description = 'Movimiento de Pendiente Decisión a Útil'

    def _get_default_dest_location_id(self):
        return self.env['stock.location'].search([('name','=','Material Útil')], limit=1).id
    ...
    location_id = fields.Many2one(
        ...
        domain="[('name', 'in', ['Material Pendiente Decisión', 'Material Pendiente Decisión 2'])]",
