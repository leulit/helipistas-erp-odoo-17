...
class HrTimesheetSwitch(models.TransientModel):
    ...
    def _onchange_date_time_or_duration(self):
        """
        Si cambia la fecha de inicio o la duración, recalcula la fecha de fin.
        """
        if self.date_time and self.unit_amount:
    ...
    def _onchange_date_time_end(self):
        """
        Si cambia la fecha de fin, recalcula la duración.
        """
