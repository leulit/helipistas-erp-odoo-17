...
class leulit_vuelo(models.Model):
    ...
    editfuelrem = fields.Float('Fuel remanente edit (l.)')
    ...
    strfechasalida = fields.Char(compute=_calc_strfecha_salida,string='Fecha Salida str')
    ...
    strhorallegada = fields.Char(compute=_strhorallegada,string='Hora llegada local str')
    ...
    strfechallegada = fields.Char(compute=_calc_fecha_llegada,string='Fecha Llegada str', store=False)
    ...
    strtiemposervicio = fields.Char(compute=_strtiemposervicio,string='Tiempo servicio str')
    ...
    motivorevision = fields.Text('Motivo revisión')
    ...
    presupuesto = fields.Many2one('sale.order','Presupuesto old')
    ...
    checklist_postvuelo_realizado = fields.Boolean('Debriefing con los tripulantes/ Inspección postvuelo realizada')
    ...
    briefing_realizado = fields.Boolean('Briefing con los tripulantes/ Briefing Salida, LLegada y Alternativo')
