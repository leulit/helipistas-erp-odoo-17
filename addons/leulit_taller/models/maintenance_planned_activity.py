...
class MiantenancePlannedactivity(models.Model):
    ...
    tag_interval = fields.Selection(selection=[('M','Meses'),('Y','Años')],string="Tag Interval")
    tarea_preventiva_id = fields.Many2one(comodel_name="leulit.maintenance_task_preventive", string="Tarea Preventiva")
    ...
    semaforo_horas = fields.Char(compute=_get_semaforo_horas, string="Semáforo Horas")
    semaforo_dias = fields.Char(compute=_get_semaforo_dias, string="Semáforo Días")
