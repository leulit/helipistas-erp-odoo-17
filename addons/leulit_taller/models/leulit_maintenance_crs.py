...
class LeulitMaintenanceCRS(models.Model):
    ...
    marca_motor = fields.Char(compute=_get_motor, string="Fabricante Motor")
    tsn_motor = fields.Float(string="TSN Motor")
    tsn_motor_str = fields.Char(string="TSN Motor (str)")
    tso_motor = fields.Char(string="TSO Motor")
    tso_motor_str = fields.Char(string="TSO Motor (str)")
    ...
    fecha = fields.Date(string="Fecha CRS", default=fields.Date.context_today)
