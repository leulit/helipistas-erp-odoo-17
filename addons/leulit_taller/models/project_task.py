...
class ProjectTask(models.Model):
    ...
    doble_check_ata = fields.Boolean(compute=_get_doble_check_from_ata, string="DC ATA")
    inspeccion_seguridad_jb = fields.Boolean(related="item_job_card_id.inspeccion_seguridad", string="IS JB")
