...
export class SearchPage extends Component {
    ...
    deleteFavorite(favoriteId) {
        ...
        fetch('/leulit_ai/delete_favorite', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-Token': odoo.csrf_token,
...
SearchPage.template = 'leulit_ai.search_page';
