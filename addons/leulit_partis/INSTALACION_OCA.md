...
| `mgmtsystem.hazard` | Activo SGSI | Gestión de activos de información con valoración C-I-D |
| `mgmtsystem.hazard.risk` | Riesgo SGSI | Análisis de riesgos según MAGERIT |
