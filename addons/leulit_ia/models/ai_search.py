...
class AISearchEngine(models.Model):
    ...
    def process_query(self, query_text):
        ...
        provider = self.env['ir.config_parameter'].sudo().get_param('leulit_ia.ai_provider', 'openrouter')
        ...
        api_key = self.env['ir.config_parameter'].sudo().get_param('leulit_ia.openrouter_api_key')
...
"""
    ...
    def _process_query_vertex(self, query_text):
        ...
        project_id = params.get_param('leulit_ia.vertex_project_id')
        region = params.get_param('leulit_ia.vertex_region') or 'europe-west4'
        allowed_raw = params.get_param('leulit_ia.vertex_allowed_models') or ''
...
class AISearchSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        params = self.env['ir.config_parameter'].sudo()
        res.update(
            openrouter_api_key=params.get_param('leulit_ia.openrouter_api_key', ''),
            ai_provider=params.get_param('leulit_ia.ai_provider', 'openrouter'),
            vertex_project_id=params.get_param('leulit_ia.vertex_project_id', ''),
            vertex_region=params.get_param('leulit_ia.vertex_region', 'europe-west4'),
            vertex_allowed_models=params.get_param('leulit_ia.vertex_allowed_models', ''),
        )
        return res
    ...
    def set_values(self):
        ...
        params = self.env['ir.config_parameter'].sudo()
        params.set_param('leulit_ia.openrouter_api_key', self.openrouter_api_key or '')
        params.set_param('leulit_ia.ai_provider', self.ai_provider or 'openrouter')
        params.set_param('leulit_ia.vertex_project_id', self.vertex_project_id or '')
        params.set_param('leulit_ia.vertex_region', self.vertex_region or 'europe-west4')
        params.set_param('leulit_ia.vertex_allowed_models', self.vertex_allowed_models or '')
